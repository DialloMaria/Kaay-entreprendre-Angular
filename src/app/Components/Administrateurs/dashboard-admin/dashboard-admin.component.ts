...
import { GuideListDashComponent } from "../Guides/guide-dashboard/guide-list.component";
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, NavbarComponent, AdminLayoutComponent, GuideListDashComponent],
